...
<div class="wrap">
    ...
    $menuItems = [
        ['label' => 'Anasayfa', 'url' => ['/isbasvuru']], // ['/site/home']],
        ...
        ['label' => 'Başvurular', 'url' => ['/isbasvuru/applicant']],
        ['label' => 'İlanlar', 'url' => ['/isbasvuru/bildiriler']],
        ['label' => 'Kategoriler', 'url' => ['/isbasvuru/bildirituru']],
